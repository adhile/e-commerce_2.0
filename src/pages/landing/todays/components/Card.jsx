...
function Card(props) {
  ...
  return (
    <>
      <div id="cards">
        {/* card */}
        <div className=" relative flex flex-col w-[270px] h-[350px] space-y-2 border-2 ">
          {/* image-box */}
          <div
            className="relative border-2 border-orange-700 w-full flex justify-center items-center h-[270px] bg-cardBg "
          ...
          <div className="absolute left-3 rounded-sm w-[55px] h-[26px] bg-brickRed text-white flex items-center justify-center">
            <p className="font-Poppins font-normal text-xs">-40%</p>
          </div>
        </div>
      </div>
    </>
